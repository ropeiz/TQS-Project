...
public final class Board {
    ...
    /**
     * Verifica si una pieza colisiona con los límites del tablero o con otras piezas ocupadas.
     *
     * Este método recorre la forma de la pieza y verifica si alguna de sus celdas ocupa
     * una posición fuera de los límites del tablero o colisiona con una celda ya ocupada.
     *
